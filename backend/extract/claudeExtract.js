        ...
        content: [
          ...
          },
          {
            ...
            text: [
              ...
              'Numbers in parentheses or red are negative: (152) means negative 152, not positive 152.',
              'This applies to the Bank box especially — a Profit (Loss) or Short/Over figure in',
              'parentheses is a loss and must be recorded negative.',
              'Separately, inside the machine meter table only, empty cells are rendered as "-" and mean',
              'zero — there, do not treat a leading "-" as a minus sign on the next value. That rule is',
              'about blank cells in the table and never overrides the parentheses rule above.',
